...
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "slowfast" / "models"))
import clip
...
cal_dataset_dis('./kinetics_400_labels.csv', './kinetics_700_labels.csv')
cal_dataset_dis('./kinetics_400_labels.csv', './kinetics_700_labels.csv', remove_overlap=True)
...
cal_dataset_dis('./kinetics_400_labels.csv', './xd_violence_7.csv')
cal_dataset_dis('./kinetics_400_labels.csv', './xd_violence_7.csv', remove_overlap=True)
