...
def add_custom_config(_C):
    ...
    _C.TEST.MERGE_WITH_BASE = False
    _C.TEST.MERGE_BASE_FILE = None
    _C.TEST.MERGE_ALPHA = 1.0
    _C.TRAIN.CUSTOM_LOAD = False
    _C.TRAIN.CUSTOM_LOAD_FILE = None
    _C.TRAIN.MERGE_WITH_BASE = False
    _C.TRAIN.MERGE_BASE_FILE = None
    _C.TRAIN.MERGE_ALPHA = 1.0
    _C.VAL_MODE = False
    ...
    _C.MODEL.MSE_MODEL_DISTILLATION = False
    _C.MODEL.EMB_MSE_RATIO  = 1.0 
