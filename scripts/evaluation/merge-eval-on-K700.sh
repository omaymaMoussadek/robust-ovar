#!/bin/bash
#
# Evaluation script for a merged checkpoint on Kinetics-700.
#
...
INDEX2CLS_FILE=$DATA/$DATASET_NAME/annotations/k700-2020-index2cls.json
PATCHING_RATIO=0.0
