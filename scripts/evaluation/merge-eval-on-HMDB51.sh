#!/bin/bash
#
# Evaluation script for a merged checkpoint on HMDB51.
#
...
LOG_DIR=/path/to/evaluation/logs/merge/hmdb51
...
INDEX2CLS_FILE=$DATA/$DATASET_NAME/annotations/hmdb51-index2cls.json
PATCHING_RATIO=0.0
