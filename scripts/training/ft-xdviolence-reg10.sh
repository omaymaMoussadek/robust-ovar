#!/bin/bash
#
# Fine-tuning script for Open-VCLIP on XD-Violence with MSE regularization.
#
...
INDEX2CLS_FILE=$ANNOTATION_DIR/XD-Violence-index2cls.json
OUTPUT_SUBDIR=finetuning_zeroshot/vitb16/mse-ratio10/ft-ovclip-mse-reg-ratio10-xdviolence
EMB_MSE_RATIO=10.0
# ============================
