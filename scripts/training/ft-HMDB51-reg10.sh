#!/bin/bash
#
# Fine-tuning script for Open-VCLIP on HMDB51 with MSE regularization.
#
...
INDEX2CLS_FILE=$ANNOTATION_DIR/hmdb51-index2cls.json
OUTPUT_SUBDIR=finetuning_zeroshot/mse-ratio10/ft-ovclip-mse-reg-ratio10-hmdb51
EMB_MSE_RATIO=10.0
# ============================
