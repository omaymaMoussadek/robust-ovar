#!/bin/bash
#
# Fine-tuning script for Open-VCLIP on Kinetics-700 with MSE regularization.
#
# This script fine-tunes a model initialized from LOAD_CKPT_FILE while enabling
# MSE model distillation with EMB_MSE_RATIO=10.0.
#
# Usage:
...
INDEX2CLS_FILE=$ANNOTATION_DIR/k700-2020-index2cls.json
OUTPUT_SUBDIR=finetuning_zeroshot/mse-ratio10/ft-ovclip-mse-reg-ratio10-k700
EMB_MSE_RATIO=10.0
# ============================
...
python -W ignore -u tools/run_net.py \
  ...
  MODEL.RAW_MODEL_DISTILLATION False \
  MODEL.MSE_MODEL_DISTILLATION True \
  MODEL.EMB_MSE_RATIO $EMB_MSE_RATIO
